            ...
            />
             ...
             <div className="absolute bottom-12 left-8 max-w-md">
                 ...
                 <p className="text-stone-300 text-sm leading-relaxed">
                     Access your dashboard, manage your schedule, and stay connected with your campus community.
                 </p>
             </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md mx-auto">
            ...
            >
                ...
                <p className="text-stone-400 mb-10 flex items-center gap-2">
                    ...
                    <Link href="/register" className="text-white underline decoration-stone-600 underline-offset-4 hover:text-orange-500 transition-colors">
                        Sign up
                    </Link>
                </p>
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    <div className="group">
                        ...
                        <div className="flex justify-end mt-2">
                             <Link href="#" className="text-xs text-stone-500 hover:text-white transition-colors">Forgot Password?</Link>
                        </div>
                    </div>
                    ...
                    <button 
                        type="submit"
                        disabled={isLoading}
                        className="cursor-pointer w-full bg-white text-black font-bold py-4 rounded-2xl hover:bg-stone-200 transition-all duration-300 flex items-center justify-between px-6 mt-4 group disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                        <span>{isLoading ? "Logging in..." : "Start Learning"}</span>
                ...
                <p className="mt-12 text-xs text-stone-600 leading-relaxed">
                    By logging in, you agree to SchoolNext's <a href="#" className="underline hover:text-stone-400">Terms of Service</a> and <a href="#" className="underline hover:text-stone-400">Privacy Policy</a>.
                </p>
            </motion.div>
        </div>
      </div>
